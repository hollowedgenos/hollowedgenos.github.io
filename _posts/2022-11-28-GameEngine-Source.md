---
title: "Game Engine: Source"
excerpt: "An overview of the Source Engine."
...
*<b>NOTE:</b> This was originally posted to Wordpress on November 28, 2022. Statements made here may or may not represent current opinions.*
{: .small}
...
Many games have been developed on the Source Engine. Besides its breakout hit, Half Life 2 and its subsequent episodes, Valve developed Team Fortress 2 on the engine, a still loved game to this day with a very active player base. The charming, interspatial manipulation puzzle game, Portal released on the Orange Box, and its sequel released years later, yes, was made on the Source Engine.  Left 4 Dead 1 & 2, Counter-Strike: Source & Global Offensive, and Dota 2 were also made in-house at Valve on the Source Engine.

---

# The Emergence of True Classics
{: .text-center}
...
# An Aging But Resilient Engine
{: .text-center}

While the Source Engine is an extraordinary and innovative piece of software, it does have its fair share of issues. Addressing the elephant in the room, the Source Engine is 18 years old, it is outdated compared to other software being developed these days. This does not mean it is a bad engine, instead the Source Engine has limitations which can only be overcome through heavy modification. Take Titanfall 2 for example, a game developed on Source, albeit heavily modified. As the Source Engine gets older, the limitations will only start to grow. However, this is not to say it is not a viable option for aspiring game developers to dip their toes into game development. There are plenty of resources available from many experienced people in the Source Engine modding community to help you get started. Source may be an aging game engine, but its effect on the gaming industry and broader community is still being felt to this day.  
